...
<aside class="col-lg-12">
	...
	<div id="tribe-events-footer">
		...
		<ul class="tribe-events-sub-nav pager">
			<li class="tribe-events-nav-previous previous"><?php tribe_the_prev_event_link( '<span aria-hidden="true">«<!--&larr;--></span> %title%' ) ?></li>
			<li class="tribe-events-nav-next next"><?php tribe_the_next_event_link( '%title% <span aria-hidden="true"><!--&rarr;-->»</span>' ) ?></li>
		</ul>
		<!-- .tribe-events-sub-nav -->
	</div>
	<!-- #tribe-events-footer -->
