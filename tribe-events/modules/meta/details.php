...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Détails', 'tribe-events-calendar' ) ?> </h3>
	<dl>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<dt> <?php esc_html_e( 'Prix :', 'tribe-events-calendar' ) ?> </dt>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<dt> <?php esc_html_e( 'Site internet :', 'tribe-events-calendar' ) ?> </dt>
